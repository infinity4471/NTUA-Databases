...
exports.Picker = function (props) {
    ...
    return (React.createElement(React.Fragment, null,
        props.input,
        props.button,
        React.createElement(kendo_react_popup_1.Popup, __assign({ style: __assign({}, (popupSettings || {}).style, { direction: props.dir }) }, popupSettings, { anchor: props.popupAnchor, anchorAlign: anchorAlign, popupAlign: popupAlign, show: props.open, open: props.onOpen, close: props.onClose, className: kendo_react_common_1.classNames('k-reset', popupSettings.className) }), props.content)));
};
